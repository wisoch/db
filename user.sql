...
CREATE TABLE IF NOT EXISTS `user_account` (
    ...
    `head_img_id`          VARCHAR(60)  NOT NULL DEFAULT '' COMMENT '头像ID',
    `source_platform`      INT          NOT NULL DEFAULT 1  COMMENT '注册平台: 1本平台',
...
CREATE TABLE IF NOT EXISTS `user_third` (
    ...
    `user_id`       INT          NOT NULL DEFAULT 0  COMMENT '用户ID',
    `platform`      VARCHAR(60)  NOT NULL DEFAULT 0  COMMENT '平台',
...
CREATE TABLE IF NOT EXISTS `user_address` (
    ...
    `address`      VARCHAR(255) NOT NULL DEFAULT '' COMMENT '完整地址: 北京 北京市 朝阳区 天畅园 7号楼 903',
